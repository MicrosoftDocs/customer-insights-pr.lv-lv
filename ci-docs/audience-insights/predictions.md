...
1. Jūsu organizācijai ir iestatīts gadījums [Common Data Service](https://docs.microsoft.com/ai-builder/build-model#prerequisites), un tā ir tāda pati organizācija kā Customer Insights.
...
5. Atjauniniet savu modeli līdzeklī AI Builder. [Uzziniet vairāk par modeļu pārvaldību līdzeklī AI Builder](https://docs.microsoft.com/ai-builder/manage-model#retrain-and-republish-existing-models).
