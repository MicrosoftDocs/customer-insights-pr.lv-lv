...
- Derīgs resurss pakalpojumā Azure, kas atbilst [Azure krātuves, Azure notikumu centrmezgla vai Azure žurnāla analīzes mērķa prasībām](/azure/azure-monitor/platform/diagnostic-settings#destination-requirements).
