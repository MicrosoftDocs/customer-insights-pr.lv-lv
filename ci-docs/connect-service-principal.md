...
Dynamics 365 Customer Insights nodrošina iespēju izveidot savienojumu ar kontu, Azure Data Lake Storage izmantojot Azure pakalpojuma principālu, nevis krātuves konta atslēgas.

Automatizētajiem rīkiem, kas izmanto Azure pakalpojumus, ir jābūt ierobežotām atļaujām. Tā vietā, lai lietojumprogrammās pieteiktos kā pilnībā priviliģēts lietotājs, Azure piedāvā pakalpojuma primāros nosaukumus. Izmantojiet pakalpojumu principālus, lai droši [pievienotu vai rediģētu common data model mapi kā datu avots](connect-common-data-model.md) vai [izveidotu vai atjauninātu vidi](create-environment.md).

## <a name="prerequisites"></a>Priekšnoteikumi

- Data Lake Storage kontam, kas izmantos pakalpojuma vadītāju, jābūt Gen2. Azure Data Lake Gen1 krātuves konti netiek atbalstīti.
- Datu ezera krātuves kontā ir [iespējota hierarhiska nosaukumvieta](/azure/storage/blobs/data-lake-storage-namespace).
- Administratora atļaujas jūsu Azure nomnieks, ja jums ir jāizveido jauns pakalpojuma vadītājs.
...
Pirms izveidojat jaunu customer insights servisa principālu, pārbaudiet, vai tas jau pastāv jūsu organizācijā. Vairumā gadījumu tas jau pastāv.
...
5. Ja atradīsit atbilstošu ierakstu, tas nozīmē, ka pakalpojuma primārais nosaukums jau pastāv. [Piešķiriet atļaujas](#grant-permissions-to-the-service-principal-to-access-the-storage-account) pakalpojuma vadītājam piekļūt krātuves kontam.
...
6. Ja rezultāti netiek atgriezti, [izveidojiet jaunu pakalpojumu principālu](#create-a-new-service-principal).
...
Lai piešķirtu atļaujas pakalpojuma vadītājam krātuves kontam, kuru vēlaties izmantot programmā Customer Insights, krātuves kontam vai konteineram ir jāpiešķir viena no šīm lomām:

|Akreditācijas datu|Prasības:|
|----------|------------|
|Pašlaik pieteicies lietotājs|**Loma**: krātuves Blob datu lasītājs, krātuves Blob līdzstrādnieks vai krātuves Blob īpašnieks.<br>**Līmenis**: krātuves kontam vai konteineram piešķirtās atļaujas.</br>|
|Customer Insights servisa direktors -<br>Izmantojiet Azure Data Lake Storage kā datu avots</br>|1. opcija<ul><li>**Loma**: krātuves Blob datu lasītājs, krātuves Blob datu līdzstrādnieks vai krātuves Blob datu īpašnieks.</li><li>**Līmenis**: krātuves kontam piešķirtās atļaujas.</li></ul>2 *. iespēja (nekopīgojot pakalpojuma galveno piekļuvi krātuves kontam)*<ul><li>**1**. loma: krātuves Blob datu lasītājs, krātuves Blob datu līdzstrādnieks vai krātuves Blob datu īpašnieks.</li><li>**Līmenis**: konteineram piešķirtās atļaujas.</li><li>**2**. loma: krātuves Blob datu delegators.</li><li>**Līmenis**: krātuves kontam piešķirtās atļaujas.</li></ul>|
|Customer Insights servisa direktors - <br>Izmantošana Azure Data Lake Storage kā izvade vai galamērķis</br>|1. opcija<ul><li>**Loma**: Krātuves Blob datu līdzstrādnieks vai krātuves Blob īpašnieks.</li><li>**Līmenis**: krātuves kontam piešķirtās atļaujas.</li></ul>2 *. iespēja (nekopīgojot pakalpojuma galveno piekļuvi krātuves kontam)*<ul><li>**Loma**: Krātuves Blob datu līdzstrādnieks vai krātuves Blob īpašnieks.</li><li>**Līmenis**: konteineram piešķirtās atļaujas.</li><li>**2**. loma: Krātuves lodes delegators.</li><li>**Līmenis**: krātuves kontam piešķirtās atļaujas.</li></ul>|
...
1. Rūtī **Pievienot lomu piešķiri** iestatiet šādus rekvizītus:
   ...
   - **Piekļuves** piešķiršana: **Lietotājam, grupai vai pakalpojuma vadītājam**
...
Pievienojiet Data Lake Storage kontu programmā Customer Insights, lai [saglabātu izvades datus](manage-environments.md) vai [izmantotu tos kā datu avots](connect-dataverse-managed-lake.md). Izvēlieties starp resursos [vai](#resource-based-storage-account-connection) [abonēšanas](#subscription-based-storage-account-connection) pieeju un veiciet šīs darbības.
