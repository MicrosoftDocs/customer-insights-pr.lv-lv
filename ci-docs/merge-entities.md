...
Lauku grupu uzskatīt par vienu vienību. Piemēram, ja mūsu ierakstos ir lauki Adrese1, Adrese2, Pilsēta, Valsts un Zip. Mēs, visticamāk, nevēlamies apvienoties cita ieraksta adresē2, domājot, ka tas padarīs mūsu datus pilnīgākus

1. **Lapā Sapludināšana** atlasiet **Apvienot**.

1. Izvēlieties **lauku** grupas opciju.

1. Norādiet sapludināšanas uzvarētāja politiku rangu **grupās pēc** nolaižamā saraksta.

1. Atlasiet **Pievienot** un izvēlieties, vai laukiem vēlaties pievienot papildu laukus vai papildu grupas.
